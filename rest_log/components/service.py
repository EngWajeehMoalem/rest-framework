...
class BaseRESTService(AbstractComponent):
    ...
    def dispatch(self, method_name, *args, params=None):
        ...
        return self._dispatch_with_db_logging(method_name,
                                              *args,
                                              params=params)
    ...
    def _dispatch_with_db_logging(self, method_name, *args, params=None):
        ...
        log_entry = self._log_call_in_db(self.env,
                                         request,
                                         method_name,
                                         *args,
                                         params=params,
    ...
    def _dispatch_exception(self,
        ...
        if hasattr(orig_exception, "errors"):
            raise exception_klass(exc_msg, log_entry_url,
                                  orig_exception.errors) from orig_exception
    ...
    def _log_call_in_db(self,
                        ...
                        *args,
                        params=None,
                        **kw):
        values = self._log_call_in_db_values(_request,
                                             *args,
                                             params=params,
                                             **kw)
        enabled_states = self._get_matching_active_conf(method_name)
        if not values or enabled_states and values[
                "state"] not in enabled_states:
            return
